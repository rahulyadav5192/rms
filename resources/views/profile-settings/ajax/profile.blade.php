<div class="col-xl-12 col-lg-12 col-md-12 ntfcn-tab-content-left w-100 p-4">
    <div class="row" >
        ...
        <div class="col-lg-4">
            <div class="form-group my-3">
                <x-forms.text class="mr-0 mr-lg-2 mr-md-2" :fieldLabel="__('Bank Name')"
                    fieldName="bank_name" fieldRequired="true" fieldId="bank_name" 
        ...
        <div class="col-lg-4">
            <div class="form-group my-3">
                <x-forms.text class="mr-0 mr-lg-2 mr-md-2" :fieldLabel="__('Account Number')"
                    fieldName="account_number" fieldRequired="true" fieldId="account_number" 
        ...
        <div class="col-lg-4">
            <div class="form-group my-3">
                <x-forms.text class="mr-0 mr-lg-2 mr-md-2" :fieldLabel="__('IFSC Code')"
                    fieldName="ifsc_code" fieldRequired="true" fieldId="ifsc_code" 
        ...
        <div class="col-lg-4">
            <div class="form-group my-3">
                <x-forms.text class="mr-0 mr-lg-2 mr-md-2" :fieldLabel="__('Branch')"
                    fieldName="branch_name" fieldRequired="true" fieldId="branch_name" 
        ...
        <div class="col-md-4">
            <x-forms.select fieldId="account_type" :fieldLabel="__('Account Type')" fieldName="account_type">
