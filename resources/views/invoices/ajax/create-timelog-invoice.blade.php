    ...
    <x-form class="c-inv-form" id="storePayments">
        ...
        <div class="row px-lg-4 px-md-4 px-3 py-3">
            ...
            <div class="col-lg-3 col-md-6">
                ...
                class="px-6 position-relative text-dark font-weight-normal form-control height-35 rounded p-0 text-left f-15" readonly>
        ...
        function getCompanyName() {
            ...
            $.ajax({
                ...
                success: function(data) {
                    ...
                    $('#currency_exchange').html('( '+companyCurrencyName+' @lang('app.to') '+data.currencyName+' )');
