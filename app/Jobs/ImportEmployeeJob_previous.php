            ...
            if ($employeeDetails) {
                ...
                try {
                    ...
                    if ($user->id) {
                        ...
                        $employee->branch_id = !empty(array_keys($this->columns, 'branch_id')) ? $this->row[array_keys($this->columns, 'branch_id')[0]] : null;
                        $employee->department_id = !empty(array_keys($this->columns, 'department_id')) ? $this->row[array_keys($this->columns, 'department_id')[0]] : null;
                        $employee->designation_id = !empty(array_keys($this->columns, 'designation_id')) ? $this->row[array_keys($this->columns, 'designation_id')[0]] : null;
