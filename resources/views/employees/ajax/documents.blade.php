                ...
                <div class="row">
                    <div class="col-md-12">
                        <select class="form-control select-picker" name="name" id="file_name" data-live-search="true">
                            ...
                            <option value="Offer Letter/Appointment Letter">Offer Letter/Appointment Letter (Previous)</option>
                            <option value="Offer Letter/Appointment Letter Niftel">Offer Letter/Appointment Letter Of Niftel (Signed)</option>
                    ...
                    <div class="col-md-12">
                        <x-forms.file :fieldLabel="__('modules.projects.uploadFile')" fieldName="file"
                            ...
                            allowedFileExtensions="pdf doc png jpg jpeg"
