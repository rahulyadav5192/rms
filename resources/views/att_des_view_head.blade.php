                ...
                <table class="table table-hover">
                  ...
                  <tbody>
                    ...
                    <tr>
                      ...
                      <td>
                          @if($d->manager_status == 0)
                          <div class="d-flex">
                            <button class="btn-sm btn-success mr-2"  data-toggle="modal" data-target="#approve{{$key}}">Approve</button>
                            <a href="{{url('reject_att_dis')}}/{{$d->id}}"><button class="btn-sm btn-danger" style="    height: 48px;">Reject</button></a>
                            
                            <!-- Approve Modal -->
                            <form class="m-4" action="{{url('att_dis_approve')}}/{{$d->user_id}}/{{$d->id}}" method="POST">
                          ...
                          @elseif($d->manager_status == 2)
                            <span class="text-success">Approved (@if($d->solve_status == 0) Sent To Hr @elseif($d->solve_status == 1) Hr Rejected @else Hr Approved @endif )</span>
                          @else
