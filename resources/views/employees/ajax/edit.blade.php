            ...
            <div class="add-client bg-white rounded">
                ...
                <div class="row p-20">
                    <div class="col-lg-9">
                        <div class="row">
                            <div class="col-md-4">
                               <x-forms.text fieldId="employee_id" 
                                    :fieldLabel="__('modules.employees.employeeId')"
                                    fieldName="employee_id" 
                                    :fieldValue="$employee->employeeDetail->employee_id"
                                    fieldRequired="true" 
                            ...
                            <div class="col-md-4">
                                <x-forms.text fieldId="email" :fieldLabel="__('modules.employees.employeeEmail')"
                                    fieldName="email" fieldRequired="false" :fieldValue="$employee->email"
                            ...
                            <div class="col-md-3">
                                <x-forms.label class="my-3" fieldId="branch"
                                ...
                                <x-forms.input-group>
                                    <select class="form-control select-picker" name="branch"
                                        ...
                                        @foreach ($branches as $branch)
                                            <option @if ($employee->employeeDetail->branch_id == $branch->id) selected @endif value="{{ $branch->id }}">
                                                {{ $branch->name }}</option>
                                        @endforeach
                                    </select>
                                    ...
                                    {{-- @if ($addDesignationPermission == 'all' || $addDesignationPermission == 'added')
                                        <x-slot name="append">
                                            <button id="branch-setting-edit" type="button"
                    ...
                    @if (user()->id == 1)
                    <div class="col-md-4">
                       <x-forms.select fieldId="policy" :fieldLabel="__('Policy Manage')"
                            fieldName="policy">
                            <!--<option value="">--</option>-->
                            <option @if ($employee->policy_manage == '0') selected @endif value="0">@lang('app.yes')</option>
                            <option @if ($employee->policy_manage != '0') selected @endif value="1">@lang('app.no')</option>
                        </x-forms.select>
                    </div>
                    @endif
                    <div class="col-md-12">
                ...
                <div class="row p-20">
                    ...
                    <div class="col-md-4">
                                <x-forms.text fieldId="offer_salary_month" :fieldLabel="__('Offer Salary Monthly')"
                                    fieldName="offer_salary_month" fieldRequired="false" :fieldValue="$employee->employeeDetail->offer_salary_month"
                                    :fieldPlaceholder="__('Offer Salary')">
                                </x-forms.text>
                    </div>
                    <div class="col-lg-3 col-md-6">
                    ...
                    <div class="col-lg-4">
                        <div class="form-group my-3">
                            <x-forms.text class="mr-0 mr-lg-2 mr-md-2" :fieldLabel="__('Bank Name')"
                                fieldName="bank_name"  fieldId="bank_name" 
                                :fieldValue="$bankDetails->bank_name ?? ''">
                            </x-forms.text>
                        </div>
                    </div>
                    ...
                    <div class="col-lg-4">
                        <div class="form-group my-3">
                            <x-forms.text class="mr-0 mr-lg-2 mr-md-2" :fieldLabel="__('Account Number')"
                                fieldName="account_number" fieldId="account_number" 
                                :fieldValue="$bankDetails->account_number ?? ''">
                            </x-forms.text>
                        </div>
                    </div>
                    ...
                    <div class="col-lg-4">
                        <div class="form-group my-3">
                            <x-forms.text class="mr-0 mr-lg-2 mr-md-2" :fieldLabel="__('IFSC Code')"
                                fieldName="ifsc_code" fieldId="ifsc_code" 
                                :fieldValue="$bankDetails->ifsc_code ?? ''">
                            </x-forms.text>
                        </div>
                    </div>
                    ...
                    <div class="col-lg-4">
                        <div class="form-group my-3">
                            <x-forms.text class="mr-0 mr-lg-2 mr-md-2" :fieldLabel="__('Branch')"
                                fieldName="branch_name" fieldId="branch_name" 
                                :fieldValue="$bankDetails->branch_name ?? ''">
                            </x-forms.text>
                        </div>
                    </div>
                ...
                <div class="alert alert-light m-4" role="alert">
                  * Salary Monthly , DOJ , Employment Type is required to generate offer letter.<br>
                  * Exit date required to generate Experience Letter
                </div>
