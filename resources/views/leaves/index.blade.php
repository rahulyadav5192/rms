...
@section('content')
    ...
    <div class="content-wrapper">
        ...
        @if($employee_det->branch_id == 7)
    <div class="row g-3 mt-3 mb-3">

        <!-- Leaves Taken Card -->
        <div class="col-md-3">
            <div class="card shadow-sm border-0 animate__animated animate__fadeInUp" style="transition: transform 0.3s;">
                <div class="card-body">
                    <h5 class="card-title text-primary"><i class="bi bi-calendar-check-fill"></i> Leaves Taken</h5>
                    <p class="card-text display-6 text-center">{{ $can_apply }}</p>
                </div>
            </div>
        </div>
        ...
        <div class="col-md-3">
            <div class="card shadow-sm border-0 animate__animated animate__fadeInUp" style="transition: transform 0.3s;">
                <div class="card-body">
                    <h5 class="card-title text-success"><i class="bi bi-calendar-plus-fill"></i> Leaves Available</h5>
                    <p class="card-text display-6 text-center">{{ $leave_bucket }}</p>
                </div>
            </div>
        </div>

        <!-- Joining Date Warning Card -->
        @if(\Carbon\Carbon::parse($employee_det->joining_date)->gt(now()->subMonths(3)))
        <div class="col-6">
            <div class="card shadow-sm border-0 bg-warning animate__animated animate__fadeInUp" style="transition: transform 0.3s;">
                <div class="card-body">
                    <h5 class="card-title text-dark"><i class="bi bi-exclamation-triangle-fill"></i> Attention</h5>
                    <p class="card-text mb-0">
                        Employee should be at least three months old to get leaves.
                    </p>
                </div>
            </div>
        </div>
        ...
        <div class="d-block d-lg-flex d-md-flex justify-content-between action-bar">
            <div id="table-actions" class="flex-grow-1 align-items-center">
                @if ($addLeavePermission == 'all' || $addLeavePermission == 'added')
                    ...
                    @elseif($addLeavePermission == 'added')
                        <!--@if($can_apply > 0)-->
                            <!--<span class="m-2"> Can't Apply More Than One Leave in A Month. </span>-->
                        <!--@else-->
                        <x-forms.link-primary :link="route('leaves.create')" class="mr-3 openRightModal float-left" icon="plus">
                            @lang('modules.leaves.addLeave') 
                        </x-forms.link-primary>
