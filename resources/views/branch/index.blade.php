    ...
    <x-filters.filter-box>
        ...
        <x-filters.more-filter-box>
            ...
            <div class="more-filter-items">
                <label class="f-14 text-dark-grey mb-12 text-capitalize" for="usr">@lang('app.menu.branch')</label>
        ...
        <div class="d-block d-lg-flex d-md-flex justify-content-between action-bar">
            <div id="table-actions" class="flex-grow-1 align-items-center">
                @if ($addDesignationPermission == 'all' || $addDesignationPermission == 'added')
                    <x-forms.link-primary :link="route('branches.create')" class="mr-3 openRightModal float-left"
                                          icon="plus">
                        @lang('app.add') @lang('app.branch')
            ...
            <div class="btn-group mt-2 mt-lg-0 mt-md-0 ml-3" role="group" aria-label="Basic example">
                <a href="{{ route('branches.index') }}" class="btn btn-secondary f-14 btn-active"
                   data-toggle="tooltip"
                   data-original-title="@lang('modules.leaves.tableView')"><i class="side-icon bi bi-list-ul"></i></a>

                <a href="{{ route('branch.hierarchy') }}" class="btn btn-secondary f-14" data-toggle="tooltip"
...
@push('scripts')
    ...
    <script>
        $('#Branch-table').on('preXhr.dt', function (e, settings, data) {
        ...
        const showTable = () => {
            window.LaravelDataTables["Branch-table"].draw(false);
        }
        ...
        const applyQuickAction = () => {
            const rowdIds = $("#Branch-table input:checkbox:checked").map(function () {
                return $(this).val();
            }).get();

            const url = "{{ route('branches.apply_quick_action') }}?row_ids=" + rowdIds;
