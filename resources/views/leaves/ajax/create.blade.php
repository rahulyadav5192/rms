...
<script>
    $(document).ready(function() {
        ...
        const maxLeaveDays = {{ $max_leave }};
        
        console.log(maxLeaveDays);
        ...
        const dp2 = $('#multi_date').datepicker({
            ...
            beforeShowDay: function(date) {
                var selectedDates = $('#multi_date').datepicker('getDates');
                if (selectedDates.length >= maxLeaveDays) {
                    return false;
                }
                return true;
            }
        ...
        $('#save-leave-form').click(function() {
            const selectedDates = $('#multi_date').datepicker('getDates');
            if ($('input[name=duration]:checked').val() == 'multiple' && selectedDates.length > maxLeaveDays) {
                alert(`You can only select up to ${maxLeaveDays} days for multiple leave.`);
                return;
            }
