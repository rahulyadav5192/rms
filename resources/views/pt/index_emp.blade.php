...
<div class=" m-3">
    ...
    <div class="card shadow-sm">
        <div class="card-header bg-secondary text-white">
            <h5 class="mb-0">Your Skill Development Tracker</h5>
        </div>
        <div class="card-body">
                ...
                <tbody>
                    @foreach ($tasks as $skill)
                        <tr>
                            ...
                            <td>{{ $skill->hr_notes }}</td>

                            <td>
                                <!-- Edit/Delete Buttons -->
                                <a href="{{url('/account/skills/employee')}}/{{$skill->ptid}}" class="btn btn-sm btn-outline-warning mr-3 d-inline-flex align-items-center justify-content-center"><i class="bi bi-pencil-fill"></i></a>
