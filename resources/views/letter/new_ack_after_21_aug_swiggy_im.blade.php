...
<meta name="viewport" content="width=device-width, initial-scale=1.0">
      <title>Niftel | Acknowledgementelement.style.backgroundColor = "#ffffff"; Letter</title>
...
<div class="offer-letter-container">
    ...
    <div class="content-wrapper" style="font-size: x-small;">
        ...
        <div class="term">
            ...
            <li>I understand that clearing both the certification round post-training and On-the-Job Training (OJT) certification is mandatory for continuation of employment. If I fail to do so, my candidature will stand cancelled, and the employment agreement will be void. I acknowledge that If I am decertified during training certification, I will be entitled to only 25% of my salary, calculated based on the number of payable days. In the case of decertification during On-the-Job Training (OJT), I will be entitled to 75% of my salary calculated based on the number of payable days.</li>
            ...
            <li>I acknowledge the company's Zero Tolerance Policy which includes, but is not limited to, rude/profane behavior towards customers or colleagues, fraudulent reporting, data fraud, unauthorized data transfer (e.g., via USB drives, personal emails), physical assault, or any act constituting an offense involving moral turpitude during employment. Breach of this policy may lead to termination, legal action, and forfeiture of dues, following a proper inquiry.</li>
