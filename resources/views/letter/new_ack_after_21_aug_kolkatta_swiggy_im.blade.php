...
<title>Niftel | Acknowledgement      element.style.backgroundColor = "#ffffff";
 Letter</title>
...
<div class="offer-letter-container">
    ...
    <div class="content-wrapper" style="font-size: x-small;">
        ...
        <div class="term">
            ...
            <li>I understand that certification post-training and OJT (On-the-Job Training) is mandatory for continued employment. In case of failure:
                <ul>
                    <li>During training: I will receive 25% of my salary, calculated based on actual payable days.</li>
                    <li>During OJT: I will receive 75% of my salary, calculated on the same basis.</li>
                    <li>I understand that failure in either stage will result in cancellation of employment without further obligation.</li>
                </ul>
            </li>
            ...
            <li>I acknowledge the company’s Zero Tolerance Policy, which prohibits, among other things:
                <ul>
                    <li>Abuse or offensive language</li>
                    <li>Fraudulent practices</li>
                    <li>Mishandling of data</li>
                    <li>Unauthorized data transfers (USB, personal email)</li>
                    <li>Assault or harassment</li>
                </ul>
