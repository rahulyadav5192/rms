...
<div class="offer-letter-container">
    ...
    <div class="content-wrapper">
        ...
        <div class="header">
            <div class="date">DATE: {{ \Carbon\Carbon::parse($emp->joining_date)->format('d-m-Y') }}</div>
        ...
        <div class="main-content">
            ...
            <ol class="terms-list">
                ...
                <li>
                    A Night Shift Allowance of <strong>INR 2,500</strong> will be provided, If you are assigned a shift 
                ...
                <li>
                    An additional Attendance Allowance of <strong>INR 500</strong> per month will be provided, subject to the following criteria:
                    <br>• Completion of 26 days of attendance within the month.
                    <br>• A minimum of 200 login hours during the month.
            
                <style>
.shrink-table td,
.shrink-table th {
    padding: 4px !important;     /* reduce spacing */
    line-height: 1.1 !important; /* reduce vertical height */
    font-size: 12px !important;  /* optional: smaller text */
}
</style>

                    <!-- EXACT TABLE AS PER PDF -->
                    <table class="shrink-table" style="width:100%; border-collapse: collapse; margin-top:10px; font-size:13px; border:2px solid #000;">
                        <tr style="background:#d3d3d3; font-weight:bold;">
                            <td style="border:1px solid #000; padding:8px;">Component</td>
                            <td style="border:1px solid #000; padding:8px;">Details / Criteria</td>
                            <td style="border:1px solid #000; padding:8px; text-align:right;">Amount (₹)</td>
                        </tr>
            
                        <tr>
                            <td style="border:1px solid #000; padding:8px;">Fixed Salary</td>
                            <td style="border:1px solid #000; padding:8px;">-</td>
                            <td style="border:1px solid #000; padding:8px; text-align:right;">
                                {{$emp->offer_salary_month}}
                            </td>
                        </tr>
            
                        <tr>
                            <td style="border:1px solid #000; padding:8px;">Night Shift Allowance</td>
                            <td style="border:1px solid #000; padding:8px;">On meeting the criteria as mentioned above</td>
                            <td style="border:1px solid #000; padding:8px; text-align:right;">2,500</td>
                        </tr>
            
                        <tr>
                            <td style="border:1px solid #000; padding:8px;">Attendance Allowance</td>
                            <td style="border:1px solid #000; padding:8px;">On meeting the criteria as mentioned above</td>
                            <td style="border:1px solid #000; padding:8px; text-align:right;">500</td>
                        </tr>
                        ...
                        <tr style="font-weight:bold;">
                            ...
                            <td style="border:1px solid #000; padding:8px; text-align:right;">
@php
    $salary = (int) preg_replace('/[^0-9]/', '', $emp->offer_salary_month);
@endphp
